...
- [Set blocks & variants](set-blocks-variants.md) — master plan in internal_docs/_future/set-blocks-variants-master-plan.md; Phase 1 (contract+builder) shipped Jul 25 2026; rulings: per-app variants, option-B flat approved storage, approval-only extraction.

...
- ANALYZER SOURCE OF TRUTH: IDCM master spec v0.4.1 (attached_assets/idcm-master-spec-v0.4.1_*.md) supersedes earlier analyzer notes; engine build deliberately deferred (user call Jul 24) — dashboard/shell first, then spec Q&A before engine work.
